...
public class Manager extends User implements CSV {
    ...
    public ArrayList <Double> IndexKPI;
    ...
    public  void KPI (){
        ...
        this.IndexKPI = new ArrayList<>(this.Size);
        Double kpi;
        for(int i = 0; i < Size; ++i){
            ...
            for(int j = 0; j < 3; ++j)
                kpi += this.Index_KPI(KPI[j], j);
            this.IndexKPI.add(kpi);
        }

    }
    private <T extends Number> double Index_KPI(T kpi, Integer i){
